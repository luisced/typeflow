  ...
  if (entries.length === 0 && !yourEntry) {
    return (
      <div className="lb-empty">
        <span className="lb-empty-icon" aria-hidden>
          <svg
            width="26"
            height="26"
            viewBox="0 0 24 24"
        ...
        <p className="lb-empty-title">No scores yet in this bucket</p>
        <p className="lb-empty-sub">
          Finish a qualifying test here and you&apos;ll be first on the board.
        </p>
      </div>
    );
  }
